...
class TwoTeamTable extends Component {
  constructor(props) {
    ...
    this.tieHandler = this.tieHandler.bind(this);
    ...
    return (
      <div className="game-scoring-area">
        ...
        <div className="form-controls">
          <form
            ref={(form) => (this.valueInputForm = form)}
            className="value-inputs"
          >
            <div className="form-separation">
              <label for="a-score-input">{this.props.teamA}</label>
              <input
                type="number"
                id="a-score-input"
                ref={this.aScoreInput}
            ...
            <div className="form-separation">
              ...
              <input
                type="number"
                id="b-score-input"
                ref={this.bScoreInput}
                className="round-score-input"
              />
            </div>
          </form>

          <button onClick={ this.checkNaN } className="regular-button">
            Registrar placar
          </button>
        </div>
      </div>
